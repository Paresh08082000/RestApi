...
<html>
  <head>
    <title>Computer Assecories Store</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  </head>
  <body>
  <h1 style="text-align:center; margin:20px;">Computer Assecories Store</h1>
    <div class="container">
      <hr />
      <p><?php echo $result ?></p>
      <form action="" method="POST">
        <div class="form-row">
          ...
          <div class="col-md-3">
            <input type="text" name="sku" class="form-control" placeholder="company" />
          </div>
          <div class="col-md-3">
            <input type="text" name="price" class="form-control" placeholder="price" />
          </div>
          <div class="col-md-3">
            <button type="submit" name="submit" value="create" class="btn btn-success">Add</button>
          </div>
        </div>
      </form>
